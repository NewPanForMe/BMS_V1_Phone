...
public class Startup
{
    ...
    {
        service.Configure<BMS_V1_Phone.Config.ProjectConfig>(_configuration.GetSection("ProjectConfig"));
        _configuration.Bind("ProjectConfig", BMS_V1_Phone.Config.ProjectConfig.Instance);
    }
